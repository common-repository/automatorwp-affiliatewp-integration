...
class AutomatorWP_AffiliateWP_Become_Affiliate extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User becomes an affiliate', 'automatorwp-affiliatewp-integration' ),
            'select_option'     => __( 'User <strong>becomes</strong> an affiliate', 'automatorwp-affiliatewp-integration' ),
            'edit_label'        => __( 'User becomes an affiliate', 'automatorwp-affiliatewp-integration' ),
            'log_label'         => __( 'User becomes an affiliate', 'automatorwp-affiliatewp-integration' ),
